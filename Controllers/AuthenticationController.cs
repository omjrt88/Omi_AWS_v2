...
namespace OMI_AWS_v2.Controllers
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        public async Task<AuthenticationResponse> Authenticate([FromBody] Credentials input)
        {
            ...
            var data = new OktaAuthenticationRequest() { username = input.Username, password = input.Password };
